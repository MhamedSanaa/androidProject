...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PostAdapter.PostViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        List<String> stringArray = (List<String>) queryDocumentSnapshot.getData().get("joinersIds");

        Log.d("user exists", "user doesnt existsppppppppppppppppppppppppp");
        ...
        if (stringArray != null && stringArray.contains(mAuth.getCurrentUser().getUid())) {
            holder.joinButton.setText("leave");
            holder.joinButton.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(context, R.color.md_theme_dark_primary)));
            holder.joinButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    db.collection("posts")
                            .document(queryDocumentSnapshot.getId())
                            .update("joinersIds", FieldValue.arrayRemove(mAuth.getCurrentUser().getUid()));
            ...
            Log.d("user exists", "user existsppppppppppppppppppppppppp");
        } else {
            holder.joinButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
